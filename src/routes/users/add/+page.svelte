    ...
    <form method="POST" use:enhance class="p-8 space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-2">
          <label
            for="firstName"
            class="block text-sm font-semibold text-slate-700">First Name</label
          >
          <input
            type="text"
            name="firstName"
            ...
            class="w-full px-4 py-2.5 rounded-xl border {form?.errors?.firstName
        ...
        <div class="space-y-2">
          <label
            for="lastName"
            class="block text-sm font-semibold text-slate-700">Last Name</label
          >
          <input
            type="text"
            name="lastName"
            ...
            class="w-full px-4 py-2.5 rounded-xl border {form?.errors?.lastName
              ? 'border-rose-300 focus:border-rose-500 focus:ring-rose-100'
              : 'border-slate-200 focus:border-indigo-500 focus:ring-indigo-100'} bg-slate-50 focus:bg-white outline-none focus:ring-4 transition-all"
            placeholder="Doe"
          />
